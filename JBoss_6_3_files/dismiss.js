...
define(['underscore', 'jquery', 'chrome_lib'], function(_, $, lib) {
    ...
    function to_jq( alert ) {
        var equal_to_alert_text = _.partial( _.isEqual, alert.text);
        var does_alert_text_equal_jquery_text = _.compose( equal_to_alert_text, $.text);
        return $(_.find( $(CONTAINER).find('[data-dismissable]'), does_alert_text_equal_jquery_text));
    }
