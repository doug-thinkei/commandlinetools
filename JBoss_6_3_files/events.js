...
define(['jquery', 'jsUri', 'analytics/events', 'analytics/attributes', 'analytics/adapters/omniture/attributes', 'chrome_lib', 's_code'], function ($, jsUri, events, attributes, om_attrs, lib) {
	...
	event_definitions = {
		...
		CertificationSearch: function () {
			...
			var cert_search_event = event_definitions.PortalSearch();
			cert_search_event.prop33 = "certification search";
			return cert_search_event;
		},
		...
		CertificationSearchResultClick: function CertificationSearchResultClickEvent() {
			...
			var cert_result_click_event = event_definitions.PortalSearchResultClick();
			cert_result_click_event.linkName = "certification search result click-through";
			return cert_result_click_event;
		},
		LabsBegin : {
			values : {
				events: "event33",
